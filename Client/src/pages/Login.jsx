  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-600 via-fuchsia-600 to-blue-700 flex items-center justify-center p-5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-10 text-3xl animate-float opacity-10">🍗</div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden animate-slide-up">
          ...
          <div className="p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mt-3">Sign in to continue your biryani journey! 🍛</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-right animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
                <a 
                  href="#" 
                  className="text-sm text-pink-600 hover:text-blue-600 transition-colors duration-300 hover:underline"
                >
                  Forgot Password?
                </a>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-black py-3 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed mt-4 relative overflow-hidden group animate-fade-in-up"
            ...
            {/* Register Link */}
            <div className="text-center mt-8 pt-4 border-t border-gray-100 animate-fade-in-up" style={{ animationDelay: "0.5s" }}>
